---
title: Pyth Network
description: Learn how to use real-time Pyth Oracle data.
---
...
Developers on Ronin have permissionless access to any of [Pyth's price feeds](https://pyth.network/developers/price-feed-ids) for equities, ETFs, commodities, foreign exchange pairs, and cryptocurrencies.

Here is a working example of a contract that fetches the latest price of ETH/USD on the Ronin network.
You have to pass [Pyth's contract address](https://docs.pyth.network/price-feeds/contract-addresses/evm) for Ronin mainnet/testnet and the desired [price feed id](https://pyth.network/developers/price-feed-ids) to fetch the latest price.
...
- Mainnet: [0x2880aB155794e7179c9eE2e38200202908C17B43](https://app.roninchain.com/address/0x2880ab155794e7179c9ee2e38200202908c17b43)
- Testnet: [0xEbe57e8045F2F230872523bbff7374986E45C486](https://saigon-app.roninchain.com/address/0xEbe57e8045F2F230872523bbff7374986E45C486)
