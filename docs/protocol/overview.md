...
used to [bail out](/protocol/validators/slashing#bailout)
...
Validators can [schedule](/protocol/validators/manage/maintenance) temporary maintenance, during which they don't get slashed for unavailability.
:::
